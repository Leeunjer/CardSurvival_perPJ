...
[RequireComponent(typeof(TileRenderer))] //  변경예정
public class HexRenderer : MonoBehaviour
{
    ...
    public bool isFlatTopped;
        ...
        protected Vector3 GetPoint(float size, float heghit, int index)
        {
            float angle_deg = isFlatTopped ? 60 * index : 60 * index - 30;
            float angle_rad = Mathf.PI / 180f * angle_deg;
            return new Vector3(size * Mathf.Cos(angle_rad) , heghit , size * Mathf.Sin(angle_rad));
        }
